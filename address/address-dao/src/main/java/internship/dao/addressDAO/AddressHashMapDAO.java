...
public class AddressHashMapDAO implements AddressDAO {
    ...
    public static AddressDAO getInstance() {
        if (dao == null) {
            ...
            Address vanya = new Address(2L, new HashSet<>(), "Russia", "Tomskaya oblast", "Promyshlennaya", "Krasnoarmeyskaya", "2", "2");
            dao.createAddress(vanya);
            Address pushkin = new Address(3L, new HashSet<>(), "Russia", "Tomskaya oblast", "Saint Petersburg", "", "", "");
